...
public class MainActivity extends AppCompatActivity {
    ...
    public static final String innerfile = "innerfile";
    private final int REQUEST_CODE = 999999;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        String extraMessage = (String) getIntent().getSerializableExtra(innerfile);
    ...
    private void setListViewItem(StringBuilder builder, List<File> files) {
        ...
        listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> adapterView, View view, int i, long l) {
                ...
                intent.putExtra(innerfile, fileNames.get(i));
